...
$(document).ready(function(){
    ...
    function init_template(){
		...
		// Put our own initializations here
		...
		if (window.location.pathname.includes("setup.html")) {
            ...
            declination_stops.oninput = function () {
                ...
                if (declination_stops.valueAsNumber == parseInt(declination_stops.min)) {
                    px += off;
                }
                if (declination_stops.valueAsNumber == parseInt(declination_stops.max)) {
                    px -= off;
                }
            ...
            rotation_stops.oninput = function () {
                ...
                if (rotation_stops.valueAsNumber == parseInt(rotation_stops.min)) {
                    px += off;
                }
                if (rotation_stops.valueAsNumber == parseInt(rotation_stops.max)) {
                    px -= off;
                }
            ...
            $('#scan').click(function () {
                ...
                $.ajax({
                    ...
                    data: JSON.stringify({
                        "declination_steps": declination_value,
                        "rotation_steps": rotation_value,
                        "start": declination_start,
                        "stop": declination_stop
                    }),
